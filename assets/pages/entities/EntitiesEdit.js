...
function EntitiesEdit() {
    ...
    useEffect(() => {
        ...
        setIsSaving(true)
        showLoader()
        axios.get(`/api/entitys/${id}`)
        .then(function (response) {
            let entity = response.data
            setDirection(entity.direction)
            setDirectionOptions(entity.directionOptions)
            setName(entity.name)
    ...
    const handleSave = () => {
        ...
        if (
            ...
            axios.post(`/api/entitys/edit/${id}`, formData)
                .then(function (response) {
                    hideLoader()
                        ...
                        <div className="card mt-3">
                            <form onSubmit={e => { e.preventDefault(); handleSave(); }}>
                                <div className="card-body p-3">
                                    <div className="mt-2 mb-4"><h4>Modifier une entité</h4></div>
