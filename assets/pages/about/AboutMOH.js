...
function AboutMOH() {
    ...
    const handleSave = () => {
        ...
        axios.post('/api/aboutmoh/maj', formData)
            .then(function (response) {
                hideLoader()
            ...
            <div className="pagetitle">
                ...
                <nav className="mt-2">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item"><Link to="/admin/aboutmoh">A propos du ministère de la santé</Link></li>
