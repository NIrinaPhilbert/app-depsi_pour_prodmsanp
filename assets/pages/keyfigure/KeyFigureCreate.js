...
function KeyFigureCreate() {
    ...
    useEffect(() => {
        setStatut(['Actif'])
        setKoption(['Graphe'])
        setDataAxis(initialFigureData)
        setTheX(initialXData)
        setTheY(initialYData)
    }, [])
    ...
    const handleSave = () => {
        ...
        if (
            ...
            axios.post('/api/key_figure/create', formData)
                .then(function (response) {
                    hideLoader()
                    toast.success("Figure ajoutée avec succès.", {
                        position: "top-right",
                        autoClose: 5000,
                        ...
                        <div className="card mt-3">
                            <form onSubmit={e => { e.preventDefault(); handleSave(); }}>
                                <div className="card-body p-3">
                                    <div className="mt-2 mb-4"><h4>Créer une nouvelle figure</h4></div>
...
export default KeyFigureCreate;