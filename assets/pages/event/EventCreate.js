                        ...
                        <div className="card mt-3">
                            <form onSubmit={e => { e.preventDefault(); handleSave(); }}>
                                <div className="card-body p-3">
                                    <div className="mt-2 mb-4"><h4>Créer un nouvel évènement</h4></div>
                                    ...
                                    <div className="w-100 mb-4">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div className="form-floating form-date-left mx-4 mb-3">
                                                    <DatePicker
                                                        className="form-control border border-outline-primary"
                                                        selected={begin}
                                            ...
                                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div className="form-floating form-date-right mx-4 mb-3">
                                                    <DatePicker
                                                        className="form-control border border-outline-primary"
                                                        selected={end}
