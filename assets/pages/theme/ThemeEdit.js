...
function ThemesEdit() {
    ...
    useEffect(() => {
        ...
        .then(function (response) {
            ...
            setPostType(theme.posttype)
            setPostTypeOptions(theme.posttypeOptions)
            setDesignation(theme.designation)
            setIsSaving(false)
            hideLoader()
        })
    ...
    const handleSave = () => {
        ...
        if (
            ...
            axios.post(`/api/themes/edit/${id}`, formData)
                .then(function (response) {
                    hideLoader()
                    toast.success("Thèmatique modifiée avec succès.", {
                        position: "top-right",
                        autoClose: 5000,
                        hideProgressBar: false,
                        closeOnClick: true,
            ...
            <div className="pagetitle">
                ...
                <nav className="mt-2">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item"><Link to="/admin/entities">Thèmatiques</Link></li>
                        ...
                        <div className="card mt-3">
                            <form onSubmit={e => { e.preventDefault(); handleSave(); }}>
                                <div className="card-body p-3">
                                    <div className="mt-2 mb-4"><h4>Modifier une thèmatique</h4></div>
                                    ...
                                    <div className="w-100 mb-4">
                                        ...
                                        <div className="form-floating mx-4 mb-3">
                                            ...
                                            <label htmlFor="posttype">Type publication <span className="text-bold text-danger text-sm">*</span></label>
                                        </div>
                                        <div className="form-floating mx-4 mb-3">
                                            <input 
